...
// the pattern grammar as type emitter. Matryoshka architecture — per-directory
...
import type { Chunk } from "../grammar/pattern.ts";
import { parsePattern } from "../grammar/pattern.ts";
